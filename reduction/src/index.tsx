...
import './index.css';
import {ReductionSettings, setSettings} from "./settings";
import axios from 'axios';
import {PluginRoute, registerRoute} from "./scigateway.actions";

export const pluginName = 'reduction';
...
export const fetchSettings = (): Promise<ReductionSettings | void> => {
    const settingsPath = process.env.REACT_APP_OPERATIONSGATEWAY_BUILD_DIRECTORY
        ...
        : '/reduction-settings.json';
    return axios
        .get<ReductionSettings>(settingsPath)
        .then((res) => {
